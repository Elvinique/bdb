...
export const SAMPLE_CANDIDATE_CONFIG: CampaignConfig = {
  ...
  partyAbbr: 'NNPP',
  partyLogoUrl: '/nnpp-logo.svg',
  campaignPosterUrl: '/candidate-official-poster.svg',
  ...
  candidatePhotoUrl: '/engr-buradum-portrait.svg',
  candidateSecondaryPhotoUrl: '/candidate-official-poster.svg',
  heroPhotoUrl: 'https://images.unsplash.com/photo-1531206715517-5c0ba140b2b8?auto=format&fit=crop&w=1400&q=80',
  communityPhotoUrl: 'https://images.unsplash.com/photo-1577962917302-cd874c4e31d2?auto=format&fit=crop&w=1200&q=80',
  socialLinks: {
